...
import (
	...
	types2 "github.com/okex/adventure/x/staking/validators/types"
...
func runValsLoop(cmd *cobra.Command, args []string) error {
	...
	// get valManager
	valManager := types2.GetValManager()
	...
	for {
		...
		log.Printf("[create success] %d 				[destroy success] %d",
			types2.CreateSuccessCnt, types2.DestroySuccessCnt)
...
func pickRebirth(curVals []gotypes.Validator, manager types2.ValManager) (vals []string) {
...
func newFilter(manager types2.ValManager) map[string]struct{} {
