...
# init
#adventure farm allocate-tokens 7000tokt -p "./template/address/farm_test/pooler_total" -n 100
adventure account send -r "giggle sibling fun arrow elevator spoon blood grocery laugh tortoise culture tool" -p "./template/address/farm_test/pooler_total" -a 7000tokt
adventure account send -r "giggle sibling fun arrow elevator spoon blood grocery laugh tortoise culture tool" -p "./template/address/farm_test/locker_total" -a 1000tokt
