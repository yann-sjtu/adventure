...
func BenchQueryCmd() *cobra.Command {
	...
	flags := cmd.Flags()
	flags.IntSliceVarP(&concurrency, "concurrency", "g", []int{1, 1, 1, 1, 1, 1, 1, 1, 1}, "set the number of query concurrent number per second")
...
var startList = []int{0, 0, 0, 0, 0, 0, 0, 0, 0}
