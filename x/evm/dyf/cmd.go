...
import (
	...
	"github.com/okex/adventure/x/evm/tools"
...
func testLoop(cmd *cobra.Command, args []string) {
	...
	clients := common.NewClientManagerWithMode(common.GlobalConfig.Networks[common.NetworkType].Hosts, "0.015okt", mode, 1500000)
